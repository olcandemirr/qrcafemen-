<template>
    <AdminLayout title="Yeni Alerjen">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Yeni Alerjen</h2>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="form.post(route('admin.allergens.store'))" class="space-y-6">
                            <!-- Alerjen Adı -->
                            <div>
